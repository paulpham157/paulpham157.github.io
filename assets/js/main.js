    ...
    function getTimelineData(title) {
        const data = {
            ...
            "EdooSmart (2025)": {
                ...
                description: 'Hành trình với EdooSmart từ cuối 2022 đã cho tôi một góc nhìn sâu sắc về tầm quan trọng của việc học tập liên tục trong kỷ nguyên AI. Dù công nghệ có phát triển nhanh đến đâu, việc học vẫn luôn là nền tảng không thể thiếu. Điều quan trọng là biết tận dụng các công cụ AI một cách thông minh để nâng cao hiệu suất công việc. Ví dụ trong lập trình, việc sử dụng Cursor AI có thể giúp tôi rút ngắn thời gian coding từ 10 giờ xuống còn 1 giờ. Tuy nhiên, để làm chủ được các công cụ này cũng đòi hỏi một quá trình học hỏi nghiêm túc. Với nền tảng "kỹ năng tự học" vững chắc, kết hợp cùng khả năng khai thác các công cụ AI như Perplexity để tìm kiếm và tổng hợp kiến thức, tôi đã có những bước tiến vượt bậc. Từ một developer cấp độ junior vào năm 2023, chỉ sau 2 năm làm việc và nghiên cứu về AI, kiến thức và kỹ năng của tôi đã phát triển vượt trội cả về chiều rộng lẫn chiều sâu. Tương lai bền vững cần gắn liền AI với giáo dục.'
            },
        };
        return data[title] || {};
    }
